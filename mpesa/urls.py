...
urlpatterns = [
    ...
    url(r'^create/mpesa/command/id/$', CreateCommandID.as_view(),
        name="create_mpesa_command_id",),
    url(r'^create/customer/phonenumber/$',PhoneNumberAPiView.as_view(),name="create_company_short_code_or_number",),
    url(r'^create/company/shortcodeornumber/$',
        CreateBusinessShortCodeOrNumber.as_view(),
    ...
    url(r'^mpesa/commandid/detail/(?P<pk>\d+)/$',
        CommandIDDetailAPIView.as_view(), name='thread'),
    ...
    url(r'^mpesacommandid/list/$',
        CommandIDListView.as_view(), name='mpesa-commandid-list'),
    ...
    url('^online_checkout/callback/', OnlineCheckoutCallback.as_view(), name='c2b_checkout_callback'),
]