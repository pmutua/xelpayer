...
import base64
from mpesa.utilities.http import get
...
def get_token(type):
    ...
    if type.lower() == 'b2c':
        ...
        auth_token = encode_str_to_base_64(concat_str)
    if type.lower() == 'lipanampesa':
        concat_str = '{}:{}'.format(settings.LIPA_NA_MPESA_ONLINE_CONSUMER_KEY, settings.LIPA_NA_MPESA_ONLINE_CONSUMER_SECRET)
        auth_token = encode_str_to_base_64(concat_str)
